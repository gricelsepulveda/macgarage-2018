...
<?php
  ...
  try {
    ...
    if($user_message != "" && $email != ""){
      ...
      //$mail->SMTPDebug = 2;
      $from = "sender@macgarage.cl"; // Correo desde el cual se mandan las solicitudes
      $mail->SMTPSecure = 'tls';
      $mail->Host = "smtp.gmail.com"; // SMTP a utilizar. Por ej. smtp.elserver.com
      $mail->Username = $from; // Correo completo a utilizar
      $mail->Password = "Sender$2019.,"; // Contraseña
      $mail->Port = 587; // Puerto a utilizar
      $mail->AddReplyTo($_POST['email'], $_POST['name']);
      $mail->SetFrom($from, $_POST['name'], $_POST['name']);
      $mail->AddAddress("contacto@macgarage.cl"); // Destinatario, debe ser el correo del cliente al cual recibe las solicitudes
